# Bộ 300 câu hỏi ôn tập AI20K — Phân theo nhánh lớn

> Bản này gom các câu hỏi theo 10 nhánh kiến thức. Mỗi nhánh có 30 câu: 10 dễ, 10 vừa và 10 khó. Nội dung, đáp án, giải thích và nguồn slide được giữ nguyên từ bộ 300 câu gốc.

## Cấu trúc học

| Nhánh | Nội dung | Dễ | Vừa | Khó | Tổng |
|---:|---|---:|---:|---:|---:|
| 1 | Nền tảng AI, LLM, Transformer và Token Economy | 10 | 10 | 10 | 30 |
| 2 | Problem-first, AI Product và Architecture Fit | 10 | 10 | 10 | 30 |
| 3 | Bot, Chatbot, Agent và ReAct | 10 | 10 | 10 | 30 |
| 4 | Prompt Engineering, Tool Calling và LangGraph | 10 | 10 | 10 | 30 |
| 5 | Prototyping, UX và Evaluation sản phẩm AI | 10 | 10 | 10 | 30 |
| 6 | Data Foundations, Memory, Embedding và Vector Store | 10 | 10 | 10 | 30 |
| 7 | RAG Pipeline, Retrieval nâng cao và Grounding | 10 | 10 | 10 | 30 |
| 8 | Multi-Agent, MCP, A2A và Orchestration | 10 | 10 | 10 | 30 |
| 9 | Data Pipeline, Data Quality và Data Observability | 10 | 10 | 10 | 30 |
| 10 | Guardrails, Deployment, Monitoring và Reliability | 10 | 10 | 10 | 30 |

---

## Nhánh 1 — Nền tảng AI, LLM, Transformer và Token Economy


### Cơ bản — Mức Dễ

Nền tảng LLM, Transformer và token
...
Token economy, API và vận hành LLM
...
Suy luận về Transformer và economics của LLM
...
## Nhánh 2 — Problem-first, AI Product và Architecture Fit


### Cơ bản — Mức Dễ

Problem-first và AI product
...
Chọn bài toán và kiến trúc AI

**Câu 41.** Tác vụ lặp lại, biến thể vừa phải, cần hiểu ngôn ngữ nhưng chưa cần hành động nhiều bước nên bắt đầu ở đâu?
...
**Câu 42.** Stakeholder nói 'hãy làm agent', nhưng chưa mô tả pain point. Bước đầu nên là gì?
...
**Câu 43.** Nếu chưa có baseline thủ công, nhóm khó kết luận điều gì?
...
**Câu 44.** Một workflow có các bước cố định nhưng cần LLM ở hai bước khác nhau. Pattern nào phù hợp?
...
**Câu 45.** Khi intent quyết định người xử lý chuyên biệt, pattern routing hữu ích vì sao?
...
**Câu 46.** Evaluator-optimizer nên dùng khi nào?
...
**Câu 47.** Một demo đẹp nhưng không có bộ test đại diện là dấu hiệu nào?
...
**Câu 48.** North Star metric nên được chọn theo tiêu chí nào?
...
**Câu 49.** Nếu một bài toán có dynamic decision và nhiều tool phụ thuộc nhau, điều gì được ưu tiên cân nhắc?
...
**Câu 50.** Go decision hợp lý hơn khi nào?
...
| Câu | Đáp án | Giải thích ngắn | Nguồn slide |
|---:|:---:|---|---|
| 41 | B | AI phù hợp với tác vụ có biến thể vừa phải; chưa cần tăng lên agent nếu workflow có thể kiểm soát. | Day 2 — Khi nào AI đáng làm |
| 42 | C | Discovery interview cần làm rõ vấn đề, tần suất, workflow và cost trước khi chọn kiến trúc. | Day 2 — Discovery Interview |
| 43 | D | Baseline là điểm tham chiếu để đo giá trị tăng thêm của AI. | Day 2 — No baseline |
| 44 | A | Prompt chaining tách task tuần tự và có thể kiểm tra output trước khi đi tiếp. | Day 2 — Workflows |
| 45 | C | Routing giảm prompt phức tạp bằng cách phân luồng theo loại yêu cầu. | Day 2 — Routing |
| 46 | D | Pattern này có một bước tạo và một bước đánh giá/cải thiện theo tiêu chí đã định. | Day 2 — Workflow Patterns |
| 47 | B | No eval path là anti-pattern vì nhóm không biết hệ thống đạt mức nào và có hồi quy hay không. | Day 2 — Eval Path |
| 48 | D | North Star gắn với outcome quan trọng nhất chứ không chỉ là metric kỹ thuật tiện đo. | Day 2 — North Star Metric |
| 49 | C | Nhiều bước, quyết định động và tool use là các tín hiệu của Agentic Fit cao. | Day 2 — Agentic Fit |
| 50 | A | Gate criteria yêu cầu bài toán có thể đo, có ranh giới và có đường triển khai khả thi. | Day 2 — Gate Criteria |
...
Problem framing, metric và quyết định kiến trúc

**Câu 51.** Stakeholder yêu cầu 'tóm tắt mọi email bằng agent'. Phát biểu nào là problem statement tốt hơn?
...
**Câu 52.** Một nhóm chọn số lượng câu trả lời sinh ra làm North Star cho trợ lý. Vì sao metric này yếu?
...
**Câu 53.** Tác vụ nhập mã lỗi cố định, luồng xử lý cố định và sai sót rất đắt nên chọn mức nào?
...
**Câu 54.** Một workflow gồm parse email → phân loại intent → tạo bản nháp. Vì sao prompt chaining là điểm bắt đầu tốt?
...
**Câu 55.** Orchestrator-workers phù hợp hơn routing đơn giản khi nào?
...
**Câu 56.** Một dự án có metric rõ nhưng không biết data có quyền truy cập hay đủ freshness. Gate nào đang thiếu?
...
**Câu 57.** Nếu metric offline tăng nhưng user không tiết kiệm thời gian hơn, nên nghi ngờ điều gì?
...
**Câu 58.** Quan sát user bỏ qua gợi ý AI vì không biết nên bắt đầu prompt thế nào gợi ý thiết kế nào?
...
**Câu 59.** Nếu baseline thủ công mất 30 phút và AI mất 20 phút nhưng tỷ lệ sửa lỗi tăng mạnh, quyết định nào cần làm?
...
**Câu 60.** Vì sao scope solution phải mô tả cả bước không có AI?
...
| Câu | Đáp án | Giải thích ngắn | Nguồn slide |
|---:|:---:|---|---|
| 51 | B | Problem statement cần actor, pain, tần suất và outcome; không lấy tên giải pháp làm vấn đề. | Day 2 — Problem Statement |
| 52 | C | North Star nên nối với outcome như thời gian tiết kiệm, resolution hoặc conversion, không chỉ volume output. | Day 2 — North Star Metric |
| 53 | D | Input ổn định, flow cố định và cost-of-error cao là tín hiệu không nên tăng độ tự chủ. | Day 2 — Rule / Workflow / Agent |
| 54 | A | Chaining phù hợp khi chuỗi bước tương đối ổn định và cần gate giữa các bước. | Day 2 — Prompt Chaining |
| 55 | B | Orchestrator-workers cho phép phân việc động; routing chỉ cần chọn nhánh đã biết. | Day 2 — Orchestrator-Workers |
| 56 | C | Discovery/feasibility phải kiểm tra nguồn, quyền, chất lượng và độ mới trước khi viết nhiều code. | Day 2 — Discovery & Feasibility |
| 57 | D | Eval kỹ thuật không tự chứng minh giá trị sản phẩm; cần nối với outcome của actor. | Day 2 — Impact Metrics |
| 58 | A | Why Johnny Can't Prompt nhấn mạnh user cần biết khả năng và cách tiếp cận task. | Day 5 — Why Johnny Can't Prompt |
| 59 | B | Tác động phải tính cả thời gian sửa, độ chính xác và rủi ro chứ không chỉ thời gian sinh output. | Day 2 / Day 5 — Impact & Cost-of-error |
| 60 | D | Day 5 nhắc không chỉ định nghĩa đoạn AI; cần biết user đi từ input đến kết quả thế nào. | Day 5 — Scope the Solution |

</details>

---

## Nhánh 3 — Bot, Chatbot, Agent và ReAct


### Cơ bản — Mức Dễ

Bot, chatbot và agent

**Câu 61.** Rule-based bot thường xử lý đầu vào bằng cách nào?
...
**Câu 62.** LLM chatbot khác agent chủ yếu ở điểm nào?
...
**Câu 63.** Agent thường cần thêm thành phần nào ngoài LLM core?
...
**Câu 64.** ReAct là viết tắt của cụm nào?
...
**Câu 65.** Thứ tự cơ bản của vòng lặp ReAct là gì?
...
**Câu 66.** Tool calling cung cấp cho agent khả năng nào?
...
**Câu 67.** Short-term memory thường nằm ở đâu?
...
**Câu 68.** Vì sao agent cần giới hạn số vòng lặp?
...
**Câu 69.** Hybrid pattern trong chatbot và agent thường làm gì?
...
**Câu 70.** Agentic Fit dùng để trả lời câu hỏi nào?
...
| Câu | Đáp án | Giải thích ngắn | Nguồn slide |
|---:|:---:|---|---|
| 61 | B | Rule-based bot hoạt động theo luồng và điều kiện do con người viết sẵn. | Day 3 — Spectrum Bot → Agent |
| 62 | C | Agent kết hợp reasoning, tools, state và vòng lặp; một LLM call đơn lẻ chưa đủ là agent. | Day 3 — So sánh hệ thống |
| 63 | D | Slide kiến trúc agent nêu goal, reasoning, tools và memory/state là các khối bổ sung. | Day 3 — Thành phần agent |
| 64 | A | ReAct kết hợp suy luận theo bước với hành động gọi công cụ. | Day 3 — ReAct |
| 65 | C | Agent phân tích trước, gọi tool sau, rồi đọc kết quả để quyết định bước tiếp. | Day 3 — ReAct Loop |
| 66 | D | Tool là 'tay chân' giúp agent lấy dữ liệu hoặc thực hiện hành động bên ngoài LLM. | Day 3 — Tool Calling |
| 67 | A | Short-term memory giữ lịch sử gần đây và thông tin cần cho phiên hiện tại. | Day 3 — Memory |
| 68 | B | Max iterations là safeguard cơ bản cùng với timeout và xử lý lỗi. | Day 3 — Max Iterations |
| 69 | D | Hybrid giúp giữ chi phí thấp ở đường đơn giản và chỉ kích hoạt agent khi cần. | Day 3 — Hybrid Pattern |
| 70 | C | Agentic Fit xem xét multi-step reasoning, tool use và quyết định động trước khi nâng cấp kiến trúc. | Day 3 — Agentic Fit |
...
ReAct, tool orchestration và kiểm lỗi agent

**Câu 71.** Trong ví dụ tìm chuyến bay và thời tiết, hai tool độc lập có thể gọi thế nào?
...
**Câu 72.** Trace có observation giá 1,75 triệu nhưng final answer nói 1,5 triệu. Lỗi chính là gì?
...
**Câu 73.** Nếu search_flights timeout, graceful degradation nên ưu tiên điều gì?
...
**Câu 74.** Stop condition tốt của ReAct agent nên dựa trên điều gì?
...
**Câu 75.** Một use case đạt điểm thấp ở reasoning, tool use và dynamic decision nên chọn gì?
...
**Câu 76.** Ngoài max iterations, safeguard nào giúp ngăn agent bị treo khi tool không phản hồi?
...
**Câu 77.** Câu hỏi FAQ một bước không cần dữ liệu mới thường phù hợp với gì?
...
**Câu 78.** Vì sao tên tool 'do_stuff' làm model chọn tool kém hơn 'search_flights'?
...
**Câu 79.** Trong ReAct, Observation khác Action ở điểm nào?
...
**Câu 80.** Vì sao agent thường đắt hơn chatbot cho cùng số query?
...
| Câu | Đáp án | Giải thích ngắn | Nguồn slide |
|---:|:---:|---|---|
| 71 | B | Nếu search_flights và get_weather không phụ thuộc dữ liệu nhau, parallel calling tiết kiệm thời gian. | Day 3 — Parallel vs Chained |
| 72 | C | Final answer không khớp observation là dấu hiệu hallucination hoặc lỗi tổng hợp. | Day 3 — Trace Debug |
| 73 | D | Agent nên không bịa dữ liệu; có thể retry có giới hạn, fallback hoặc nói rõ chưa đủ evidence. | Day 3 — Tool Failure |
| 74 | A | Agent dừng khi task hoàn tất hoặc không thể tiến thêm trong boundary, không dừng chỉ vì số bước tùy ý. | Day 3 — Stop Condition |
| 75 | C | Agentic Fit thấp cho thấy độ phức tạp của agent chưa tạo thêm giá trị. | Day 3 — Agentic Fit Score |
| 76 | D | Timeout giới hạn thời gian chờ; retry và fallback cần được thiết kế bổ sung. | Day 3 — Agent Loop Control |
| 77 | A | Không nên dùng agent cho bài toán một bước, không tool và yêu cầu deterministic cao. | Day 3 — Anti-patterns |
| 78 | B | Tool name là tín hiệu phân loại đầu tiên; tên rõ giúp model định hướng chức năng. | Day 3 — Tool Definition |
| 79 | D | Action gửi yêu cầu tới tool; Observation là dữ liệu môi trường trả lại cho agent. | Day 3 — Thought / Action / Observation |
| 80 | C | Mỗi bước reasoning hoặc synthesis có thể phát sinh thêm token và latency. | Day 3 — Agent Cost |
...
Agent loop, control flow và debug trace

**Câu 81.** Trace có ba lỗi: gọi weather trước khi có flight, dùng HCM thay SGN, và final answer đổi 1,75M thành 1,5M. Cách phân loại đúng là gì?
...
**Câu 82.** Hai tool A và B độc lập, nhưng B cần output A. Chiến lược nào tối ưu mà vẫn đúng?
...
**Câu 83.** Agent liên tục gọi lại cùng tool dù observation không thay đổi. Bộ kiểm soát nào nên phối hợp?
...
**Câu 84.** Tool trả timeout tạm thời nhưng retry lần đầu vẫn lỗi. Retry policy production nên có gì?
...
**Câu 85.** Agent có thể trả lời từ knowledge nội tại nhưng user hỏi giá realtime. Stop condition đúng yêu cầu gì?
...
**Câu 86.** Native function calling được ưu tiên hơn ReAct text thuần trong production vì sao?
...
**Câu 87.** Triage route cho FAQ đơn giản nhưng route nhầm sang agent. Tác động đầu tiên thường là gì?
...
**Câu 88.** Long-horizon task dễ khác task một lượt ở điểm nào?
...
**Câu 89.** Một bộ eval agent nên chấm riêng tool selection thay vì chỉ chấm final answer vì sao?
...
**Câu 90.** Nếu một agent trung bình gọi 3 LLM step/query và chatbot gọi 1 step/query, scale 1 triệu query sẽ nhạy với gì?
...
| Câu | Đáp án | Giải thích ngắn | Nguồn slide |
|---:|:---:|---|---|
| 81 | B | Day 3 chỉ rõ thứ tự tool, mã IATA và sự lệch evidence là ba loại lỗi cần sửa khác nhau. | Day 3 — Trace Bugs |
| 82 | C | Orchestration nên dựa trên dependency graph: parallel ở nhánh độc lập, sequential ở nhánh phụ thuộc. | Day 4 — Tool Execution Strategies |
| 83 | D | Nhiều safeguard cần đi cùng nhau vì một vòng lặp không kiểm soát có thể đốt token và side effect. | Day 3 / Day 4 — Loop Control |
| 84 | A | Retry cần phân biệt transient/permanent failure và giới hạn số lần để bảo vệ cost. | Day 3 / Day 4 — Tool Failure |
| 85 | B | Goal và evidence cần khớp; knowledge tĩnh không thay thế được dữ liệu realtime. | Day 3 — ReAct Evidence |
| 86 | C | Hybrid thường dùng reasoning/control của ReAct cùng format tool call có cấu trúc. | Day 3 — ReAct vs Function Calling |
| 87 | D | Agent có nhiều call hơn; hybrid route giúp tránh dùng độ phức tạp không cần thiết. | Day 3 — Hybrid Pattern |
| 88 | A | Task dài làm tăng rủi ro mất state, loop, retry trùng và cần durable execution. | Day 3 / Day 12 — Long Horizon |
| 89 | B | Day 3 nêu reasoning quality, tool selection, arguments, error handling và stopping là các điểm cần xem. | Day 3 — Agent Evaluation |
| 90 | D | Agent cost scale theo số call và token mỗi call; cần napkin math trước khi mở rộng. | Day 3 — Cost at Scale |

</details>

---

## Nhánh 4 — Prompt Engineering, Tool Calling và LangGraph


### Cơ bản — Mức Dễ

Prompt fundamentals và tool schema
...
Prompt production-grade và tool calling
...
Prompt contract, tool schema và LangGraph
...
## Nhánh 5 — Prototyping, UX và Evaluation sản phẩm AI


### Cơ bản — Mức Dễ

Prototype, UX và đánh giá AI

**Câu 121.** Prototype dùng để làm gì trong AI product?
...
**Câu 122.** Low-fidelity prototype thường giúp kiểm tra điều gì?
...
**Câu 123.** Wizard of Oz MVP có đặc điểm nào?
...
**Câu 124.** Trong PRD cho AI feature, problem statement nên tránh điều gì?
...
**Câu 125.** Non-goals trong PRD dùng để làm gì?
...
**Câu 126.** Augmentation khác automation ở điểm nào?
...
**Câu 127.** Khi cost-of-error rất cao, thiết kế phù hợp thường là gì?
...
**Câu 128.** Precision cao ưu tiên giảm loại lỗi nào?
...
**Câu 129.** Recall cao ưu tiên giảm loại lỗi nào?
...
**Câu 130.** Vibe check trong eval AI có hạn chế nào?
...
| Câu | Đáp án | Giải thích ngắn | Nguồn slide |
|---:|:---:|---|---|
| 121 | B | Prototype giúp học nhanh từ giả thuyết rẻ nhất trước khi build đầy đủ. | Day 5 — AI Prototyping |
| 122 | C | Low-fidelity phù hợp để kiểm tra workflow; high-fidelity mới gần trải nghiệm thật hơn. | Day 5 — Fidelity |
| 123 | D | Wizard of Oz kiểm tra nhu cầu bằng trải nghiệm giống AI nhưng phần xử lý có thể thủ công. | Day 5 — Wizard of Oz |
| 124 | A | Day 5 nhắc problem statement nên nói về vấn đề của user, không giả định AI là đáp án. | Day 5 — Scope & PRD |
| 125 | C | Non-goals giúp kiểm soát kỳ vọng và tránh mở rộng scope ngoài mục tiêu. | Day 5 — Goals / Non-goals |
| 126 | D | Mức agency nên chọn theo độ chắc chắn và cost-of-error của hành động. | Day 5 — Augmentation vs Automation |
| 127 | A | Với hành động khó hoàn tác, friction của phê duyệt là cơ chế kiểm soát hữu ích. | Day 5 — Cost of Error |
| 128 | B | Precision quan tâm trong các kết quả được dự đoán là dương tính, nên nhạy với false positive. | Day 5 — Precision / Recall |
| 129 | D | Recall đo mức bao phủ các trường hợp đúng, nên cần giảm bỏ sót. | Day 5 — Precision / Recall |
| 130 | C | Demo mượt vài câu không thay thế được bộ case đại diện và quy trình đánh giá lặp lại. | Day 5 — Eval Flow |
...
AI product UX và eval cơ bản

**Câu 131.** Trợ lý soạn email đề xuất nội dung nhưng không tự gửi là dạng nào?
...
**Câu 132.** Bộ lọc video trẻ em đánh dấu video là xấu khi thực tế lành mạnh. Đây là lỗi gì?
...
**Câu 133.** Trust calibration tốt cần kết hợp những yếu tố nào?
...
**Câu 134.** Vì sao confidence tag High/Medium/Low có thể tốt hơn số 0,84?
...
**Câu 135.** Khi AI thiếu thông tin để hiểu câu hỏi mơ hồ, fallback tốt là gì?
...
**Câu 136.** Cùng một input cho ra hai output khác nhau là loại failure nào?
...
**Câu 137.** Vì sao eval AI nên lặp lại trước và sau thay đổi?
...
**Câu 138.** Guideline 'make clear what the system can do' chủ yếu xử lý vấn đề nào?
...
**Câu 139.** Trong Wizard of Oz, giả định rủi ro nhất nên được kiểm tra thế nào?
...
**Câu 140.** Nếu PRD nói rõ goal nhưng không nói non-goal, rủi ro dễ gặp là gì?
...
| Câu | Đáp án | Giải thích ngắn | Nguồn slide |
|---:|:---:|---|---|
| 131 | B | Người dùng vẫn duyệt và chỉnh kết quả; mức agency thấp hơn automation hoàn toàn. | Day 5 — Augmentation |
| 132 | C | Hệ thống báo nhầm dương tính là false positive; nếu cost của nó cao thì ưu precision. | Day 5 — Precision / Recall |
| 133 | D | Người dùng tin đúng mức khi biết khả năng, lý do và quyền can thiệp của hệ thống. | Day 5 — Trust Calibration |
| 134 | A | Người dùng cần biết nên tin và kiểm tra thế nào hơn là một số phần trăm thiếu ngữ cảnh. | Day 5 — Confidence UX |
| 135 | B | Graceful fallback giữ tính trung thực và giúp user bổ sung thông tin cần thiết. | Day 5 — Graceful Failure |
| 136 | C | Nondeterminism là mặc định của hệ thống sinh; acceptance criteria cần phản ánh mức biến thiên. | Day 5 — Nondeterminism |
| 137 | D | Eval là chu trình, không phải một lần chấm demo. | Day 5 — Eval Flow |
| 138 | A | UI cần cho user biết khả năng và giới hạn trước khi họ giao việc cho AI. | Day 5 — Human-AI Interaction |
| 139 | C | MVP kiểu Wizard of Oz kiểm tra nhu cầu và hành vi trước khi đầu tư kỹ thuật lớn. | Day 5 — Wizard of Oz |
| 140 | D | Non-goal là hàng rào sản phẩm giúp team biết điều gì chưa nằm trong phiên bản này. | Day 5 — PRD |
...
Thiết kế AI product dưới bất định

**Câu 141.** AI có accuracy khá cao nhưng đôi khi gửi email sai người. Quyết định agency nào hợp lý?
...
**Câu 142.** Trong hệ thống phát hiện nội dung nguy hiểm cho trẻ em, bỏ lọt là lỗi nghiêm trọng hơn báo nhầm. Nên ưu tiên gì?
...
**Câu 143.** Acceptance criteria cho output sinh nên viết thế nào để đối phó nondeterminism?
...
**Câu 144.** Một UI hiển thị 'AI knows everything' nhưng feature chỉ có dữ liệu đến 2024. Lỗi thiết kế là gì?
...
**Câu 145.** Khi confidence thấp nhưng hành động có thể hoàn tác, UX nào hợp lý?
...
**Câu 146.** Vì sao eval AI không thể chỉ dùng pass/fail như unit test thuần?
...
**Câu 147.** Một feature có ba fallback: sửa output, yêu cầu user duyệt, chuyển người thật. Vì sao phải ghi vào PRD?
...
**Câu 148.** Đội ngũ cần kiểm tra workflow nhưng chưa chắc có nhu cầu AI. Prototype nào phù hợp?
...
**Câu 149.** AI feature đọc nội dung cuộc họp có thể chứa PII. PRD cần mô tả thêm gì ngoài user flow?
...
**Câu 150.** Một sản phẩm AI đo được thumbs-up thấp nhưng LLM judge cao. Nên làm gì?
...
| Câu | Đáp án | Giải thích ngắn | Nguồn slide |
|---:|:---:|---|---|
| 141 | B | Sai recipient là side effect khó hoàn tác; augmentation và approval giảm cost-of-error. | Day 5 — Agency / Cost-of-error |
| 142 | C | Khi FN gây hại lớn, cần tối đa hóa coverage và có thể dùng human review cho phần nghi ngờ. | Day 5 — Precision / Recall |
| 143 | D | AI có nhiều câu trả lời hợp lệ; acceptance cần đo mức đạt, factuality, format và failure handling. | Day 5 — Nondeterminism |
| 144 | A | Trust giảm khi UI hứa vượt khả năng; cần nói rõ phạm vi, thời điểm dữ liệu và cách AI có thể sai. | Day 5 — Trust Calibration |
| 145 | B | Control, preview và rollback cho phép dùng AI trong vùng rủi ro vừa phải. | Day 5 — Recovery UX |
| 146 | C | Output sinh cần chấm theo mức độ, relevance, faithfulness hoặc rubric thay vì một chuỗi duy nhất. | Day 5 — Eval vs Software Test |
| 147 | D | Fallback là quyết định sản phẩm, không chỉ là exception kỹ thuật. | Day 5 — Fallback 3 Tầng |
| 148 | A | Build rẻ trước để giảm rủi ro học sai bài toán. | Day 5 — Prototyping / MVP |
| 149 | B | AI-specific requirements phải nêu input/context và privacy controls, không chỉ mô tả nút bấm. | Day 5 — Privacy / AI Requirements |
| 150 | C | Các tầng quality khác nhau có thể không đồng thuận; cần xem case và outcome thay vì tin một số. | Day 5 / Day 13 — Quality Metrics |

</details>

---

## Nhánh 6 — Data Foundations, Memory, Embedding và Vector Store


### Cơ bản — Mức Dễ

Data foundations, embedding và vector store
...
Data, memory và retrieval design
...
Data architecture và semantic retrieval
...
## Nhánh 7 — RAG Pipeline, Retrieval nâng cao và Grounding


### Cơ bản — Mức Dễ

RAG pipeline và grounding
...
Advanced retrieval và generation trong RAG
...
RAG end-to-end, grounding và evaluation
...
## Nhánh 8 — Multi-Agent, MCP, A2A và Orchestration


### Cơ bản — Mức Dễ

Multi-agent, MCP và LangGraph
...
Thiết kế multi-agent, MCP và A2A
...
Multi-agent orchestration, MCP và reliability
...
## Nhánh 9 — Data Pipeline, Data Quality và Data Observability


### Cơ bản — Mức Dễ

Data pipeline và data observability
...
Ingestion, data quality và pipeline control
...
Data pipeline, quality gate và incident triage
...
## Nhánh 10 — Guardrails, Deployment, Monitoring và Reliability


### Cơ bản — Mức Dễ

Guardrails, deployment và monitoring
...
Safety, deployment và observability
...
Safety, deployment và observability tích hợp
...
Bản gốc theo thứ tự mức độ vẫn nằm trong `question_bank_300.md`. Bản hiện tại phù hợp để học theo chủ đề: hoàn thành một nhánh ở cả ba mức trước khi chuyển sang nhánh tiếp theo.
